...
void shop::interact() {
    ...
    do {
        ...
        std:: cout << "HP: " << charHP << " | Wallet: " << wallet << " credits.\n"
            ...
            << "[2] Upgrade Armor (" << charDef << " >> " << (charDef + 20) << "): " << armorPrice << " credits.\n"
            << "[3] Buy Heal Stim: " << p1Price << " credits. || Heal HP by 20 points.\n"
            << "[4] Buy X-Stim: " << p2Price << " credits. || Fully restore HP.\n"
            << "[5] Exit\n";
        std::cin >> shopInput;
        ...
        if (shopInput == 1) {
            ...
            if (wallet < armorPrice) {
                ...
                system("cls");
                std::cout << "Your shield capacity has been increased by 20!\n"
                    << "Thank you for your purchase!\n" << std::endl;
                charDef += 20;
                wallet -= armorPrice;
            }
            ...
            if (wallet < p1Price) {
                ...
                if (charHP == 100) {
                    ...
                    std::cout << "Your health has increased by 20!\n"
                        << "Thank you for your purchase!\n" << std::endl;
                    charHP += 20;
                }
            }
